...
import { Card, Avatar, Typography, Tabs, List, Tag, Spin, Empty, Button, Divider } from 'antd';
import { UserOutlined, StarOutlined, EditOutlined, EyeOutlined } from '@ant-design/icons';
          ...
          <div className="w-full md:w-1/3">
            <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
              <div className="flex flex-col items-center text-center">
                ...
                <Text type="secondary" className="mb-4">{user.email}</Text>
